...
public:
    ...
    static StringList nmdcConnectionSpeeds;

    enum StrSetting { STR_FIRST,
                      NICK = STR_FIRST, UPLOAD_SPEED, ADC_UPLOAD_SPEED, NMDC_UPLOAD_SPEED,
                      DESCRIPTION, DOWNLOAD_DIRECTORY,
                      ...
                      SHADOWSOCKS_SERVER, SHADOWSOCKS_PASSWORD, SHADOWSOCKS_METHOD,
    ...
    enum IntSetting { INT_FIRST = STR_LAST + 1,
                      ...
                      AUTO_AWAY, SOCKS_PORT, SOCKS_RESOLVE, SOCKS_STEALTH, SOCKS_TLS, PROXY_P2P_CONNECTIONS,
                      SHADOWSOCKS_PORT, SHADOWSOCKS_TRANSPORT,
