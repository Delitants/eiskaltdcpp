...
bool ConnectivityManager::shouldStartDht(bool useDht, bool incomingActive, int outgoingMode, bool hasUdpRelay) {
    if(!useDht)
        return false;
...
void ConnectivityManager::startDht(bool incomingActive) {
#ifdef WITH_DHT
